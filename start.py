...
import system.chatgpt as chatgpt
...
class Cheetah(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            print("Recording and transcribing using Cheetah version : %s" % o.version)

            out = ""

            while True:
                partial_transcript, is_endpoint = o.process(recorder.read())
                out = out + partial_transcript
...
class Porcupine(Thread):
    """
    Microphone Cheetah for Porcupine wake word engine. It creates an input audio stream from a microphone, monitors it, and
...
def processTranscript(transcript):
    ...
    # TODO: Add ability to cancel the readout
...
def main():
    ...
    parser.add_argument(
        "--keywords",
        nargs="+",
        help="List of default keywords for detection. Available keywords: %s"
